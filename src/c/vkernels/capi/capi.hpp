 ...
 *     is uint8 (host for *_fp8_cpu, device for vk_hip_*_fp8).
 *   - round_scale_or_null is float* for *_fp8_cpu (host scalar) and
 *     const void* for vk_hip_*_fp8 (device int or NULL); *it > 0 selects
