...
// thin wrapper over the public API in csrc/vkernels/ (kernels, core, comm).
...
PYBIND11_MODULE(_core, m) {
  ...
  // -------------------------------------------------------------------------
  auto core = m.def_submodule("core", "Device and Stream (csrc/vkernels/core).");
  ...
  auto kernels = m.def_submodule(
      "kernels", "Element-wise, reduction and GEMM kernels (csrc/vkernels/kernels).");
  ...
  // -------------------------------------------------------------------------
  auto comm = m.def_submodule("comm", "Communication primitives (csrc/vkernels/comm).");
